...
export const StudentRepository = {
  ...
  async update(id, studentData) {
    try {
      ...
      console.log('🚀 StudentRepository.update - Data being sent:', JSON.stringify(data, null, 2));
      console.log('📋 StudentRepository.update - Enrollments in data:', JSON.stringify(data.enrollments, null, 2));
      ...
      if (files && Object.keys(files).length > 0) {
        ...
        // No files, send as JSON for better data preservation
        console.log('StudentRepository.update - Sending as JSON:', JSON.stringify({ data }, null, 2));
